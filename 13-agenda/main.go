...
// GerenciadorContatos : componente responsavel por gerenciar contatos
...
func (gerenciador *GerenciadorContatos) carregarContatos() ([]Contato, error) {
	...
	if _, e := os.Stat(ARQUIVO); os.IsExist(e) {
...
func (gerenciador *GerenciadorContatos) salvarContatos(contato ConversivelParaString) error {
...
func criarNovoContato(gerenciador *GerenciadorContatos) {
	...
	err := gerenciador.salvarContatos(&novoContato)
	if err != nil {
